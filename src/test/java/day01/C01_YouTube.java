...
public class C01_YouTube extends TestBase {
    ...
    public void test01() {
        ...
        //Files.delete(Paths.get(""pc kullanıcı yolunuz/Downloads/TARKAN - Kuzu Kuzu (Original).mp3"));
        ...
        //indirmeyi dogrula
        Assert.assertTrue(Files.exists(Paths.get("pc kullanıcı yolunuz/TARKAN - Kuzu Kuzu (Original).mp3")));
    }
